...
<head>
    <title>Code coverage report for src/request-data-packages.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> request-data-packages.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">92.23% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>95/103</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>92/100</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { RedstoneOraclesState } from "@redstone-finance/oracles-smartweave-contracts";
import {
  SignedDataPackage,
...
export const requestDataPackages = async (
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (reqParams.dataFeeds.length &lt; 1) {
<span class="cstat-no" title="statement not covered" >    throw new Error("Please provide at least one dataFeed");</span>
  }
  try {
...
const prepareDataPackagePromises = (
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (reqParams.authorizedSigners &amp;&amp; reqParams.authorizedSigners.length == 0) {
<span class="cstat-no" title="statement not covered" >    throw new Error("authorizer signers array, if provided, cannot be empty");</span>
  }
