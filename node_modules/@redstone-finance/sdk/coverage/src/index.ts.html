    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>30/39</span>
            </div>
...
&nbsp;
  switch (format) {
<span class="branch-0 cbranch-no" title="branch not covered" >    case "json":</span>
<span class="cstat-no" title="statement not covered" >      return JSON.stringify(payload.toObj(), null, 2);</span>
<span class="branch-1 cbranch-no" title="branch not covered" >    case "bytes":</span>
<span class="cstat-no" title="statement not covered" >      return JSON.stringify(Array.from(payload.toBytes()));</span>
    default:
