...
<head>
    <title>Code coverage report for src/common/env.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/common</a> env.ts</h1>
        <div class='clearfix'>
...
<a name='L41'></a><a href='#L41'>41</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { z, ZodDefault, ZodOptional, ZodType, ZodTypeDef } from "zod";
...
export const getFromEnv: GetFromEnvType = &lt;T = string&gt;(
  ...
  const envValue = isNodeRuntime() ? process.env[name] : <span class="branch-1 cbranch-no" title="branch not covered" >undefined;</span>
