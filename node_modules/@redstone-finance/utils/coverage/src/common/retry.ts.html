...
<head>
    <title>Code coverage report for src/common/retry.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/common</a> retry.ts</h1>
        <div class='clearfix'>
...
<a name='L61'></a><a href='#L61'>61</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { loggerFactory } from "../logger";
...
export function retry&lt;T extends (...args: any[]) =&gt; Promise&lt;unknown&gt;&gt;(
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (config.maxRetries === 0) {
