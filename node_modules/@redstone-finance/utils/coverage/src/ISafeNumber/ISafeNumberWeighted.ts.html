...
<head>
    <title>Code coverage report for src/ISafeNumber/ISafeNumberWeighted.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/ISafeNumber</a> ISafeNumberWeighted.ts</h1>
        <div class='clearfix'>
...
<a name='L58'></a><a href='#L58'>58</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { ISafeNumber, SafeZero, calculateSum, getMedian } from ".";
&nbsp;
...
&nbsp;
export const normalizeWeightedValues = <span class="fstat-no" title="function not covered" >(</span>
  weightedValues: WeightedValue[]
): WeightedValue[] =&gt; {
  const sum = <span class="cstat-no" title="statement not covered" >calculateSum(weightedValues.map(<span class="fstat-no" title="function not covered" >(v</span>alue) =&gt; <span class="cstat-no" title="statement not covered" >value.weight)</span>);</span>
<span class="cstat-no" title="statement not covered" >  return weightedValues.map(<span class="fstat-no" title="function not covered" >(w</span>eightedValue) =&gt; (<span class="cstat-no" title="statement not covered" >{</span></span>
    value: weightedValue.value,
