...
<head>
    <title>Code coverage report for src/ISafeNumber/ISafeNumberFactory.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/ISafeNumber</a> ISafeNumberFactory.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">6x</span>
<span class="cline-any cline-yes">6x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { NumberArg } from "./ISafeNumber";
