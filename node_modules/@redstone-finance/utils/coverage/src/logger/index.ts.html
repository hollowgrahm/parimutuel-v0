...
<a name='L27'></a><a href='#L27'>27</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import consola, { FancyReporter, JSONReporter } from "consola";
import { z } from "zod";
...
export const loggerFactory = (moduleName: string) =&gt; {
  if (isNodeRuntime()) {
    ...
    const mainReporter = enableJsonLogs
      ? new JSONReporter()
      : <span class="branch-1 cbranch-no" title="branch not covered" >new FancyReporter();</span>
&nbsp;
    return consola
      .create({
