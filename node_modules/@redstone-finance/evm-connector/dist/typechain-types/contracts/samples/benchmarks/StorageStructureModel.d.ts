...
export interface StorageStructureModelInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "aggregateValues" | "executeRequestWith10ArgsWithPrices" | "executeRequestWith3ArgsWithPrices" | "executeRequestWith5ArgsWithPrices" | "extractTimestampsAndAssertAllAreEqual" | "getAllMockAuthorised" | "getAllMockExceptLastOneAuthorised" | "getAuthorisedMockSignerIndex" | "getAuthorisedSignerIndex" | "getDataServiceId" | "getUniqueSignersThreshold" | "requestsWith10Args" | "requestsWith3Args" | "requestsWith5Args" | "sendRequestWith10Args" | "sendRequestWith3Args" | "sendRequestWith5Args" | "setDeleteFromStorage" | "validateTimestamp"): FunctionFragment;
