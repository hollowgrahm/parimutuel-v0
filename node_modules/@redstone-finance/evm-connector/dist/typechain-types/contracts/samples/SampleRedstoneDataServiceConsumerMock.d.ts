...
export interface SampleRedstoneDataServiceConsumerMockInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "aggregateValues" | "extractTimestampsAndAssertAllAreEqual" | "firstValue" | "getAllMockAuthorised" | "getAllMockExceptLastOneAuthorised" | "getAuthorisedMockSignerIndex" | "getAuthorisedSignerIndex" | "getDataServiceId" | "getUniqueSignersThreshold" | "save2ValuesInStorage" | "save2ValuesInStorageWithManualPayload" | "secondValue" | "validateTimestamp"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "save2ValuesInStorageWithManualPayload", values: [PromiseOrValue<BytesLike>[], PromiseOrValue<BytesLike>]): string;
    ...
    decodeFunctionResult(functionFragment: "save2ValuesInStorageWithManualPayload", data: BytesLike): Result;
...
export interface SampleRedstoneDataServiceConsumerMock extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SampleRedstoneDataServiceConsumerMockInterface;
    ...
    functions: {
        ...
        save2ValuesInStorageWithManualPayload(dataFeedIds: PromiseOrValue<BytesLike>[], arg1: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        save2ValuesInStorageWithManualPayload(dataFeedIds: PromiseOrValue<BytesLike>[], arg1: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        secondValue(overrides?: CallOverrides): Promise<BigNumber>;
        validateTimestamp(receivedTimestampMilliseconds: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
...
//# sourceMappingURL=SampleRedstoneDataServiceConsumerMock.d.ts.map