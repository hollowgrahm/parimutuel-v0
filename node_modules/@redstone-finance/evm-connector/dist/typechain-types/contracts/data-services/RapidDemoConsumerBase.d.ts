...
export interface RapidDemoConsumerBaseInterface extends utils.Interface {
    functions: {
...
export interface RapidDemoConsumerBase extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: RapidDemoConsumerBaseInterface;
...
//# sourceMappingURL=RapidDemoConsumerBase.d.ts.map