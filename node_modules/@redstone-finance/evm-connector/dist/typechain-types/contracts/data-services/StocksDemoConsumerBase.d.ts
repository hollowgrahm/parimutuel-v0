...
export interface StocksDemoConsumerBaseInterface extends utils.Interface {
    functions: {
...
export interface StocksDemoConsumerBase extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: StocksDemoConsumerBaseInterface;
...
//# sourceMappingURL=StocksDemoConsumerBase.d.ts.map