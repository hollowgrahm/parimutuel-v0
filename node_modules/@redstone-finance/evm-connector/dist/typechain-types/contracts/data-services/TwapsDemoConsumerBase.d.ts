...
export interface TwapsDemoConsumerBaseInterface extends utils.Interface {
    functions: {
...
export interface TwapsDemoConsumerBase extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TwapsDemoConsumerBaseInterface;
...
//# sourceMappingURL=TwapsDemoConsumerBase.d.ts.map